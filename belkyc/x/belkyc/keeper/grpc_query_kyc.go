...
func (k Keeper) KycAll(c context.Context, req *types.QueryAllKycRequest) (*types.QueryAllKycResponse, error) {
	if req == nil {
...
func (k Keeper) Kyc(c context.Context, req *types.QueryGetKycRequest) (*types.QueryGetKycResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(c)
